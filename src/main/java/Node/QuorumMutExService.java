...
public class QuorumMutExService {
    ...
    public void intakeRequest(int sourceUid, int sourceClock) {
        ...
        log.trace("in intake request for sourceUid {} and sourceClock {}", sourceUid, sourceClock);
    ...
    public void processRelease(int sourceUid, int sourceCriticalSectionNumber) {
        log.debug("Inside processRelease for sourceUid {}, sourceCritialSectionNumber {}", sourceUid,sourceCriticalSectionNumber);
    ...
    public void processFailed(int sourceUid) {
        log.debug("Inside processFailed, sourceUid {}", sourceUid);
    ...
    public void processGrant(int sourceUid, int sourceCriticalSectionNumber) {
        log.debug("Inside processGrant, for sourceUid {}, sourceCriticalSectionNumber {}", sourceUid,sourceCriticalSectionNumber);
        csRequesterInfo.mergeCriticalSectionNumber(sourceCriticalSectionNumber);
    ...
    public void processInquire(int sourceUid, int sourceScalarClock) {
        log.debug("Inside processInquire, sourceUid {}, sourceScalarClock {}", sourceUid,sourceScalarClock);
    ...
    public void processYield(int sourceUid) {
        log.debug("Inside processYield, sourceUid {}", sourceUid);
        quorumMutExInfo.setInquireSent(false);
        Queue<CsRequest> requestQueue = quorumMutExInfo.getWaitingRequestQueue();
        if(requestQueue.size() > 0) {
